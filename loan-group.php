<?php
$pageTitle = "Group Loan Scheme | Financial Support | Kalyani Foundation";
$pageDescription = "Apply for a group loan through Kalyani Foundation. Designed to support Self Help Groups (SHGs).";
$activePage = "programs-group-loan";
...
?>
    ...
    <header class="page-header bg-white position-relative overflow-hidden py-5">
        ...
        <div class="container position-relative z-1" data-aos="fade-up">
            ...
            <h1 class="page-header-title mb-3">Group Loan <span class="text-gradient">Scheme</span></h1>
            ...
            <p class="lead text-muted mx-auto" style="max-width: 650px; font-size: 1.1rem; line-height: 1.6;">ग्रुप लोन योजना - Fostering community strength and shared responsibility by providing collective capital to Self Help Groups (स्वयं सहायता समूह).</p>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 pe-lg-5 text-center text-lg-start" data-aos="fade-right">
                    ...
                    <p class="text-muted mb-4 lh-lg" style="font-size: 1.05rem;">Our Group Loan Scheme is built on the proven microfinance model of collective liability. It is specifically designed to fund community-driven businesses, such as cooperative manufacturing or farming initiatives led by women's Self Help Groups (SHGs).</p>
                            ...
                            <div class="p-4 bg-white rounded-4 border-start border-primary border-4 shadow-sm h-100">
                                ...
                                <ul class="list-unstyled d-flex flex-column gap-2 mb-0" style="font-size: 0.9rem; line-height: 1.5;">
                                    <li class="d-flex align-items-start gap-2">
                                        ...
                                        <span>Larger collective capital pools.</span>
                                    </li>
                                    <li class="d-flex align-items-start gap-2">
                                        <i class="fa-solid fa-chevron-right text-success mt-1" style="font-size: 0.75rem;"></i>
                                        <span>Builds savings and financial discipline.</span>
                                    </li>
                                    <li class="d-flex align-items-start gap-2">
                                        <i class="fa-solid fa-chevron-right text-success mt-1" style="font-size: 0.75rem;"></i>
                                        <span>Cooperative management training.</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="p-4 bg-white rounded-4 border-start border-accent border-4 shadow-sm h-100">
                                ...
                                <p class="text-muted mb-0" style="font-size: 0.9rem; line-height: 1.6;">
                                    Must be a registered Self Help Group (SHG) of 5 to 20 members with a clean savings and meetings record.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6" data-aos="fade-left" data-aos-delay="200">
                    <div class="position-relative px-2">
                        <div class="image-offset-wrapper">
                            <img src="images/loan_group_1781940949765.png" class="img-fluid rounded-4 shadow-lg w-100" style="height: 440px; object-fit: cover;" alt="Group Loan Meeting">
                            <!-- Floating Badge -->
                            <div class="glass-badge position-absolute bottom-0 start-0 m-4 p-3 d-flex align-items-center gap-3 border-radius-md" style="border-radius: var(--radius-md);">
                                ...
                                <div>
                                    <h4 class="fw-extrabold text-primary mb-0 h4">₹1L - ₹5L</h4>
                                    <p class="small text-muted mb-0 fw-bold text-uppercase" style="letter-spacing: 0.5px; font-size: 0.7rem;">Group Loan Bracket</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="py-5 bg-dark text-white text-center position-relative overflow-hidden">
        ...
        <div class="container position-relative z-1" data-aos="zoom-in">
            <h3 class="mb-2 text-white fw-bold">Empower Your Community</h3>
            <p class="text-white-50 mb-4" style="max-width: 500px; margin: 0 auto 24px;">Have your SHG representative contact our center to initiate the group loan process.</p>
