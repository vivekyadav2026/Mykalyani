<?php
$pageTitle = "Tailoring Scheme (सिलाई योजना) | Free Training | Kalyani Foundation";
$pageDescription = "Enroll in our free tailoring scheme for women. Learn stitching and garment making to become financially independent.";
$activePage = "programs-tailoring";
...
?>
    ...
    <header class="page-header bg-white position-relative overflow-hidden py-5">
        ...
        <div class="container position-relative z-1" data-aos="fade-up">
            ...
            <h1 class="page-header-title mb-3">Tailoring <span class="text-gradient">Scheme</span></h1>
            ...
            <p class="lead text-muted mx-auto" style="max-width: 650px; font-size: 1.1rem; line-height: 1.6;">सिलाई योजना - Empowering women with the skills to design, stitch, and create a sustainable livelihood from home.</p>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 pe-lg-5 text-center text-lg-start" data-aos="fade-right">
                    ...
                    <p class="text-muted mb-4 lh-lg" style="font-size: 1.05rem;">Our Tailoring Scheme is designed to help women from rural and semi-urban areas gain practical stitching skills. The program is 100% free and covers everything from basic sewing to advanced garment design.</p>
                            ...
                            <div class="p-4 bg-white rounded-4 border-start border-primary border-4 shadow-sm h-100">
                                ...
                                <ul class="list-unstyled d-flex flex-column gap-2 mb-0" style="font-size: 0.9rem; line-height: 1.5;">
                                    <li class="d-flex align-items-start gap-2">
                                        ...
                                        <span>100% Free Tuition & materials.</span>
                                    </li>
                                    <li class="d-flex align-items-start gap-2">
                                        <i class="fa-solid fa-chevron-right text-success mt-1" style="font-size: 0.75rem;"></i>
                                    ...
                                    <li class="d-flex align-items-start gap-2">
                                        <i class="fa-solid fa-chevron-right text-success mt-1" style="font-size: 0.75rem;"></i>
                                        <span>Guidance to start a home boutique.</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="p-4 bg-white rounded-4 border-start border-accent border-4 shadow-sm h-100">
                                ...
                                <p class="text-muted mb-0" style="font-size: 0.9rem; line-height: 1.6;">
                                    Open to all women above 18 years of age residing in our operational districts. No prior sewing experience is required.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6" data-aos="fade-left" data-aos-delay="200">
                    <div class="position-relative px-2">
                        <div class="image-offset-wrapper">
                            <img src="images/training_tailoring_1781940867813.png" class="img-fluid rounded-4 shadow-lg w-100" style="height: 440px; object-fit: cover;" alt="Women Tailoring Classes">
                            <!-- Floating Badge -->
                            <div class="glass-badge position-absolute bottom-0 start-0 m-4 p-3 d-flex align-items-center gap-3 border-radius-md" style="border-radius: var(--radius-md);">
                                ...
                                <div>
                                    <h4 class="fw-extrabold text-primary mb-0 h4">3 Months</h4>
