<?php
$pageTitle = "Pickle Making Training | Micro-Employment | Kalyani Foundation";
$pageDescription = "Join our pickle making training program and start your own micro-enterprise.";
$activePage = "programs-pickle";
...
?>
    ...
    <header class="page-header bg-white position-relative overflow-hidden py-5">
        ...
        <div class="container position-relative z-1" data-aos="fade-up">
            ...
            <h1 class="page-header-title mb-3">Pickle Making <span class="text-gradient">Training</span></h1>
            ...
            <p class="lead text-muted mx-auto" style="max-width: 650px; font-size: 1.1rem; line-height: 1.6;">आचार बनाने का प्रशिक्षण - Learn the art of commercial pickle manufacturing to generate immediate, sustainable income from home.</p>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 pe-lg-5 text-center text-lg-start" data-aos="fade-right">
                    ...
                    <p class="text-muted mb-4 lh-lg" style="font-size: 1.05rem;">Our Pickle Making Training is a specialized micro-employment initiative. We teach women how to hygienically prepare, preserve, and package traditional pickles for commercial sale in local and regional markets.</p>
                            ...
                            <div class="p-4 bg-white rounded-4 border-start border-primary border-4 shadow-sm h-100">
                                ...
                                <ul class="list-unstyled d-flex flex-column gap-2 mb-0" style="font-size: 0.9rem; line-height: 1.5;">
                                    <li class="d-flex align-items-start gap-2">
                                        ...
                                        <span>Food safety & preservation practice.</span>
                                    </li>
                                    <li class="d-flex align-items-start gap-2">
                                        <i class="fa-solid fa-chevron-right text-success mt-1" style="font-size: 0.75rem;"></i>
                                        <span>Packaging, labeling & FSSAI guidance.</span>
                                    </li>
                                    <li class="d-flex align-items-start gap-2">
                                        <i class="fa-solid fa-chevron-right text-success mt-1" style="font-size: 0.75rem;"></i>
                                        <span>Direct connections to market sales.</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="p-4 bg-white rounded-4 border-start border-accent border-4 shadow-sm h-100">
                                ...
                                <p class="text-muted mb-0" style="font-size: 0.9rem; line-height: 1.6;">
                                    Open to all women and Self Help Groups (SHGs). Candidates must commit to the full duration of the workshop sessions.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6" data-aos="fade-left" data-aos-delay="200">
                    <div class="position-relative px-2">
                        <div class="image-offset-wrapper">
                            <img src="images/employment_pickle_1781940982237.png" class="img-fluid rounded-4 shadow-lg w-100" style="height: 440px; object-fit: cover;" alt="Pickle Making Training">
                            <!-- Floating Badge -->
    ...
    <section class="py-5 bg-dark text-white text-center position-relative overflow-hidden">
        ...
        <div class="container position-relative z-1" data-aos="zoom-in">
            ...
            <p class="text-white-50 mb-4" style="max-width: 500px; margin: 0 auto 24px;">Contact our center to join the next batch of our pickle making workshop.</p>
