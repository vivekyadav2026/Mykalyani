<?php
$pageTitle = "About Us | Mykalyani Foundation";
$pageDescription = "Learn about the history, mission, and dedicated team behind Mykalyani Foundation.";
$activePage = "about";
...
?>
    ...
    <header class="page-header bg-white position-relative overflow-hidden py-5">
        ...
        <div class="container position-relative z-1" data-aos="fade-up">
            <span class="eyebrow-tag text-primary mx-auto d-table mb-3">Our Story</span>
            <h1 class="page-header-title mb-3">About <span class="text-gradient">Mykalyani Foundation</span></h1>
            ...
            <p class="lead text-muted mx-auto" style="max-width: 650px; font-size: 1.1rem; line-height: 1.6;">A government-recognized organization committed to female empowerment, self-reliance, and sustainable rural development.</p>
        </div>
    </header>

    <!-- Overview Section (Split Layout with Hindi Text) -->
    ...
    <section class="section-padding bg-dark text-white position-relative overflow-hidden">
        <div class="hero-shape hero-shape-1" style="background: var(--primary); opacity: 0.15; top: -20%; left: -10%;"></div>
        <div class="hero-shape hero-shape-2" style="background: var(--secondary); opacity: 0.1; bottom: -20%; right: -10%;"></div>
        <div class="container position-relative z-1">
            <div class="row g-4">
                <div class="col-lg-6" data-aos="fade-up">
                    <div class="glass-panel-dark text-white h-100 p-4 p-md-5 d-flex flex-column align-items-center text-center align-items-lg-start text-lg-start">
                        <div class="icon-box bg-white bg-opacity-15 text-white mb-4"><i class="fa-solid fa-bullseye fs-3"></i></div>
                        <h3 class="mb-3 text-white fw-bold">Our Mission</h3>
                        <p class="text-white-50 fs-6 lh-lg mb-0">
                            To empower marginalized rural families by providing direct access to quality vocational skills, sustainable micro-enterprises, and micro-loan pathways—fostering self-reliance and dismantling multi-generational cycles of poverty.
                        </p>
                    </div>
                </div>
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="glass-panel-dark text-white h-100 p-4 p-md-5 d-flex flex-column align-items-center text-center align-items-lg-start text-lg-start">
                        <div class="icon-box bg-white bg-opacity-15 text-white mb-4"><i class="fa-solid fa-eye fs-3"></i></div>
                        <h3 class="mb-3 text-white fw-bold">Our Vision</h3>
                        <p class="text-white-50 fs-6 lh-lg mb-0">
                            We envision a thriving rural society where women lead successful household businesses, achieve absolute financial independence, and hold key decision-making roles within their communities and homes.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="timeline-track mt-2">
                        ...
                        <div class="timeline-node">
                            ...
                            <div class="bg-white p-4 rounded-4 shadow-sm border border-light">
                                ...
                                <p class="text-muted fs-6 mb-0 lh-relaxed">Officially registered the charitable foundation. Established our flagship training facility providing free professional sewing, papad-making, and beauty care modules.</p>
                            </div>
                        </div>
                        <div class="timeline-node">
                            ...
                            <div class="bg-white p-4 rounded-4 shadow-sm border border-light">
                                ...
                                <p class="text-muted fs-6 mb-0 lh-relaxed">Secured Section 80G & 12A tax exemption statuses. Launched our micro-loans scheme helping female groups start household packaging and production units.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="section-padding bg-white">
        <div class="container">
            <div class="text-center mb-5 pb-2" data-aos="fade-up">
                ...
                <h2 class="fw-bold">Dedicated Visionaries</h2>
                ...
                <p class="text-muted mx-auto" style="max-width: 600px;">The driving force behind Mykalyani Foundation, coordinating field implementation and maintaining total financial transparency.</p>
            </div>
            ...
            <div class="row g-4 justify-content-center team-grid">
                    ...
                    <div class="profile-card h-100 d-flex flex-column align-items-center justify-content-between p-3 p-md-4">
                        <div class="text-center">
                            <div class="position-relative d-inline-block">
                                <img src="images/avatar_kalyani_devi.png" class="profile-avatar mb-3" alt="Kalyani Devi">
                            ...
                            <h4 class="fw-bold h6 mb-1 text-dark" style="font-size: 1.05rem;">Mrs. Kalyani Devi</h4>
                ...
                <div class="col-12 col-md-4 d-flex justify-content-center mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="300">
                    <div class="profile-card h-100 d-flex flex-column align-items-center justify-content-between p-3 p-md-4" style="max-width: 360px; width: 100%;">
                        ...
                        <p class="text-muted mb-0 italic-quote font-small" style="font-size: 0.82rem; line-height: 1.5; font-style: italic;">
                            "Standardizing our sewing, beauty, and computer courses ensures our graduates find steady work."
                        </p>
                    </div>
                </div>
            </div>
