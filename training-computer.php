<?php
$pageTitle = "Computer Training (कम्प्यूटर प्रशिक्षण) | Free Training | Kalyani Foundation";
$pageDescription = "Enroll in our free computer training scheme. Bridge the digital divide and learn basic computing skills for office jobs.";
$activePage = "programs-computer";
...
?>
    ...
    <header class="page-header bg-white position-relative overflow-hidden py-5">
        ...
        <div class="container position-relative z-1" data-aos="fade-up">
            <span class="eyebrow-tag text-primary mx-auto d-table mb-3">Free Skill Training (प्रशिक्षण)</span>
            <h1 class="page-header-title mb-3">Computer <span class="text-gradient">Training</span></h1>
            ...
            <p class="lead text-muted mx-auto" style="max-width: 650px; font-size: 1.1rem; line-height: 1.6;">कम्प्यूटर प्रशिक्षण - Bridging the digital divide by teaching essential computing and office administration skills.</p>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 pe-lg-5 text-center text-lg-start" data-aos="fade-right">
                    ...
                    <p class="text-muted mb-4 lh-lg" style="font-size: 1.05rem;">In today's digital world, computer literacy is crucial. Our 100% free Computer Training program covers basic operating system usage, word processing, spreadsheets, and safe internet browsing.</p>
                            ...
                            <div class="p-4 bg-white rounded-4 border-start border-primary border-4 shadow-sm h-100">
                                ...
                                <ul class="list-unstyled d-flex flex-column gap-2 mb-0" style="font-size: 0.9rem; line-height: 1.5;">
                                    <li class="d-flex align-items-start gap-2">
                                        ...
                                        <span>Dedicated smart lab machines.</span>
                                    </li>
                                    <li class="d-flex align-items-start gap-2">
                                        <i class="fa-solid fa-chevron-right text-success mt-1" style="font-size: 0.75rem;"></i>
                                        <span>Basic office software tools.</span>
                                    </li>
                                    <li class="d-flex align-items-start gap-2">
                                        <i class="fa-solid fa-chevron-right text-success mt-1" style="font-size: 0.75rem;"></i>
                                        <span>Preparation for office roles.</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="p-4 bg-white rounded-4 border-start border-accent border-4 shadow-sm h-100">
                                ...
                                <p class="text-muted mb-0" style="font-size: 0.9rem; line-height: 1.6;">
                                    Open to youth and adults above 16 years of age in our districts. Basic regional language reading and writing skills are required.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6" data-aos="fade-left" data-aos-delay="200">
                    <div class="position-relative px-2">
                        <div class="image-offset-wrapper">
                            <img src="images/training_computer_1781940894876.png" class="img-fluid rounded-4 shadow-lg w-100" style="height: 440px; object-fit: cover;" alt="Computer Training Lab">
                            <!-- Floating Badge -->
                            <div class="glass-badge position-absolute bottom-0 start-0 m-4 p-3 d-flex align-items-center gap-3 border-radius-md" style="border-radius: var(--radius-md);">
                                ...
                                <div>
                                    <h4 class="fw-extrabold text-primary mb-0 h4">6 Months</h4>
                                    <p class="small text-muted mb-0 fw-bold text-uppercase" style="letter-spacing: 0.5px; font-size: 0.7rem;">Course Duration</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="py-5 bg-dark text-white text-center position-relative overflow-hidden">
        ...
        <div class="container position-relative z-1" data-aos="zoom-in">
            <h3 class="mb-2 text-white fw-bold">Ready to Start Learning?</h3>
            <p class="text-white-50 mb-4" style="max-width: 500px; margin: 0 auto 24px;">Enroll in our next batches. Admissions are fully free for female candidates.</p>
